      ...
      <div className='container'>
        <div className='imgpara' >
          <div className='Text' data-aos="fade-down-right">
            ...
            <div className='textthird' ><small>1. We always deliver by using insurance so that the luggage is safe and prosperous. We are always focused on your convenience </small></div>
            <div className='textfourth' ><small>2. Always safe by being able to communicate with our logistics driver anywhere & anytime. </small></div>
