    ...
    <>
      ...
      <div className=' container carD' data-aos="fade-up" >
        <div className='imgparaD' >
           ...
           <div className='TextD' ><p>We offer <b> complete solutions </b> for the transportation of goods from large manufacturers or SMEs to the end customers and retailers. At<b> LoadKro </b>, you can find many logistics services provider who can help you transport goods at a reasonable rate.</p>   
           </div>
